...
# Shuai-Pj2: this is a multi-task version
# Inception-Resnet-A
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                net_2 = slim.flatten(net)
                net_2 = slim.fully_connected(net_2, 1024, activation_fn=None,
                                                 scope='Fully_1', reuse=False)
                ...
                net_2 = slim.fully_connected(net_2, 512, activation_fn=None,
                                             scope='Fully_4', reuse=False)


                features = slim.fully_connected(net_2, 40, activation_fn=None,
                                                 scope='output_40', reuse=False)
                ...
                with tf.variable_scope('Logits'):
                    ...
                    net_1 = slim.avg_pool2d(net, net.get_shape()[1:3], padding='VALID',
                                          scope='AvgPool_1a_8x8')
                    net_1 = slim.flatten(net_1)

                    net_1 = slim.dropout(net_1, dropout_keep_prob, is_training=is_training,
                                             scope='Dropout')
                    end_points['PreLogitsFlatten'] = net_1

                embedding = slim.fully_connected(net_1, bottleneck_layer_size, activation_fn=None,
                                                 scope='Bottleneck', reuse=False)




    return embedding, features, end_points